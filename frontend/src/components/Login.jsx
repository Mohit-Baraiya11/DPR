...
const Login = ({ onLogin }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="p-8 bg-white rounded-lg shadow-lg glass-effect max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">SMART DPR</h1>
          <p className="text-gray-600">Sign in to manage your reports through Google Sheets</p>
        </div>
